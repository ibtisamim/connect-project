                            ...
                            <div class="col-12  col-lg-8 col-sm-6">
                                <div class="form-group">
                                    <div class="controls">
                                        ...
                                        <input type="text" required class="form-control" placeholder="Name (English)" name="name_en">
                            ...
                            <div class="col-12  col-lg-8 col-sm-6">
                                <div class="form-group">
                                    <div class="controls">
                                        ...
                                        <input type="text" required class="form-control" placeholder="Name (Arabic)" name="name_ar">
