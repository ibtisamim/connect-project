                  ...
                  <div class="col-12  col-lg-8 col-sm-6">
                    <div class="form-group">
                      <div class="controls">
                        ...
                        <input type="text" required class="form-control" placeholder="Title (English)" name="sub_title_en">
                  ...
                  <div class="col-12  col-lg-8 col-sm-6">
                    <div class="form-group">
                      <div class="controls">
                        ...
                        <input type="text" required class="form-control" placeholder="Title (Arabic)" name="sub_title_ar">
                    ...
                    <div class="form-group">
                      <div class="controls">
                              <div class="form-group" style="margin:50px auto;">
                                <input type="file" required name="image_testimonial" hidden class="demo" id="exampleInputFile"  data-jpreview-container="#demo-1-container" >
                              </div>
