    ...
    <div class="card">
      <div class="card-body">
        <div class="col-12 d-flex align-items-center justify-content-end pb-1">
          <a href="{{route('report_reasons.create')}}" class="btn btn-sm btn-success">Add Report Reason</a>
        </div>
        <!-- datatable start -->
            ...
            <tbody>
                @foreach ($items as $item)
                    <tr>
                        ...
                        @csrf
                        @method('delete')
                        <button type="button" style="display: inline-block; width: auto;padding: 0; border: 1px solid #ccc; padding: 5px; border-radius: 5px; line-height: 12px;" class="dropdown-item" onclick="confirm('{{ __("Are you sure you want to delete this report reason ?") }}') ? this.parentElement.submit() : ''">
