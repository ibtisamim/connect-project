    ...
    <div class="card-body">
      <div class="tab-content">
        <div class="tab-pane active fade show" id="account" aria-labelledby="account-tab" role="tabpanel">
            ...
            <form action="{{route('admins.update',$admin->id)}}" method="POST" autocomplete="off" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="row justify-content-center">
                  <div class="col-12 col-lg-7 col-sm-6">
                      <div class="form-group">
                        <div class="controls">
                            <label>Name</label>
                            <input type="text" value="{{$admin->name}}" required class="form-control" placeholder="Name" name="name">
                            @if ($errors->has('name'))
                      ...
                      <div class="form-group">
                        <div class="controls">
                          ...
                          <label for="exampleInputFile" id="demo-1-container" class="jpreview-container">
                            <img width="150" src="{{url('uploads/'.$admin->media[0]->id.'/'.$admin->media[0]->file_name)}}" id="imgMain" alt="">
                          </label>
                          @if ($errors->has('image'))
