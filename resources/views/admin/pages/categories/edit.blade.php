                  ...
                  <div class="col-12 col-lg-12 col-sm-6">
                      <div class="form-group">
                        <div class="controls">
                            ...
                            <input type="text" value="{{$category->title}}" required class="form-control" placeholder="Title (English)" name="title_en">
                  ...
                  <div class="col-12 col-lg-12 col-sm-6">
                    <div class="form-group">
                      <div class="controls">
                        ...
                        <textarea type="text"  name="description_en">{{$category->description}}</textarea>
                  ...
                  <div class="col-12 col-lg-12 col-sm-6">
                    <div class="form-group">
                      <div class="controls">
                        ...
                        <input type="text" value="{{$category->getTranslation('title', 'ar')}}" required class="form-control" placeholder="Title (Arabic)" name="title_ar">
                  ...
                  <div class="col-12 col-lg-12 col-sm-6">
                    <div class="form-group">
                      <div class="controls">
                        ...
                        <textarea type="text"  name="description_ar">{{$category->getTranslation('description', 'ar')}}</textarea>
