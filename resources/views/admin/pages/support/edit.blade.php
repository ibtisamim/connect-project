    ...
    <div class="card-body">
      <div class="tab-content">
        <div class="tab-pane active fade show" id="account" aria-labelledby="account-tab" role="tabpanel">
            ...
            <form action="{{route('support.update',$support)}}" method="POST" autocomplete="off" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                  ...
                  <div class="col-12 col-lg-8 col-sm-6">
                    <div class="form-group">
                      <div class="controls">
                        ...
                        <textarea type="text"  name="question_en" >{!! $support->question !!}</textarea>
                  ...
                  <div class="col-12 col-lg-8 col-sm-6">
                    <div class="form-group">
                      <div class="controls">
                        ...
                        <textarea type="text"  name="question_ar">{{$support->getTranslation('question', 'ar') }}</textarea>
                  ...
                  <div class="col-12 col-lg-8 col-sm-6">
                    <div class="form-group">
                      <div class="controls">
                        ...
                        <textarea type="text"  name="answer_en">
                        {!! $support->answer !!}
                  ...
                  <div class="col-12 col-lg-8 col-sm-6">
                    <div class="form-group">
                      <div class="controls">
                        ...
                        <textarea type="text"  name="answer_ar">  {{$support->getTranslation('answer', 'ar') }}</textarea>
