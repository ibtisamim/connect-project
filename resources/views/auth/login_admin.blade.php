@extends('admin.layouts.AdminLoginLayoutMaster')
{{-- title --}}
@section('title','Login')
{{-- page scripts --}}
@section('page-styles')
              ...
              <div class="card-body">
                ...
                <form method="POST" action="{{ route('admin_login') }}">
                  ...
                  <div class="form-group mb-50">
                    <label class="text-bold-600" for="email">User Name</label>
                    <input id="name" type="text" class="form-control @error('name') is-invalid @enderror" name="name" value="{{ old('name') }}"  autocomplete="name" autofocus placeholder="Name address">
                    @error('name')
