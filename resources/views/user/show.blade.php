                ...
                <div class="profile_section">
                  ...
                  {{--  <div class="contact_info1">
                    ...
                    <div class="location">
                        ...
                        @if (($user_data->city_id != null) && ($user_data->country_id != null))
        ...
        <div class="col-md-12" >
            ...
            <div class="owl-carousel front-end-page owl-theme">
                        ...
                        <div class="image_category_project">
                            ...
                            @else
                            <img src="/img/project-cover-placeholder-8.png" class="collection_project_img">
                            @endif
                            @endforeach 
                        ...
                        <div class="info_category">
                            ...
                            <div class="collection_short_info">

                                <h2 style="font-size:18px">{{$collection->name}}</h2>

                                <p>
                                    {{ \Illuminate\Support\Str::limit($collection->description, 50, $end='...') }}
                                </p>
