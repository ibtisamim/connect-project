            ...
            <div class="col-xs-12 col-md-12">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        ...
                        <a href="javascript:void(0);" id="closechat"><i class="fa fa-caret-down" aria-hidden="true"></i></a>
                        <a href="javascript:void(0);" id="openchat" style="display:none"><i class="fa fa-caret-up" aria-hidden="true"></i></a>
                    </div>
                    ...
                    <div class="panel-footer">
                        <div class="input-group form-controls">
                            ...
                            <button class="btn btn-primary btn-sm btn-chat" type="button" data-to-user="" disabled>
                                <i class="fa fa-file"></i> Send</button>
                        </div>
