...
<div class="background-home profile_business">
    <strong><center><h1 style="font-size: 30px; text-transform: uppercase;">Tell us more about your company</h1></center></strong>
    <div class="box_field2" style="padding-top:5em">
                ...
                <p class="col-md-12 row" id="main_title_register">Legal</p>
                <div class="row">
                        <div class="input-group mt-3 col-md-6">
                                    <div class="col-md-3"><lable>Legal ID</lable></div>
                                    <div class="col-md-9">
                        ...
                        <div class="input-group mt-3 col-md-4">
                                    <div class="col-md-3"><lable>VAT #</lable></div>
                                    <div class="col-md-9">
                ...
                <p class="col-md-12 row" id="main_title_register">Location</p>
                    ...
                    <div class="col-md-6 row" >
                        ...
                        <p class="col-md-12 row" id="main_title_register">Contact</p>
                         <div class="col-md-12 row" >
                                <div class="input-group mt-3 col-md-6">
                                    <div class="col-md-3"><lable>Phone Number</lable></div>
                                ...
                                <div class="input-group mt-3 col-md-6">
                                    <div class="col-md-3"><lable>Website</lable></div>
                                    <div class="col-md-9">
